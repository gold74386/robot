...
openai_api_key = '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'
...
class VoiceAssistantUI:
    def __init__(self, master):
        ...
        self.log_text = scrolledtext.ScrolledText(self.master, width=40, height=10)
        self.log_text.pack()

        self.start_button = tk.Button(self.master, text="Start Conversation", command=self.start_conversation)
        ...
        try:
           ...
           if picowakeword.myaudio is not None:
            ...
            if picowakeword.myaudio is not None:
               ...
               #Orator()
        # 在这里调用您的语音识别和对话系统的代码
        # 例如，调用Orator()函数或相关的代码
        self.log("Conversation started...")

        # 模拟对话过程
        self.log("User: Hello")
        self.log("Assistant: Hi there!")
